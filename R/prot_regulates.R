#' Proteins regulated by a protein (prot_regulates)
#'
#' Function to obtain proteins that are regulated by a specific protein, filtered by regulation type.
#'
...
#'
#' @return A data.frame containing regulated protein labels, definitions, regulatory relation labels, databases, articles, and evidence levels, sorted by protein label. If no data is available, a message is returned.
#'
#' @examples
#' \dontrun{
#' prot_regulates("BRCA1_HUMAN", regulation_type = "negative")
#' }
#'
#' @export
